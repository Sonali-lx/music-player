...
const SearchBar = ({ setSearchSongs }) => {
  ...
  useEffect(() => {
    ...
    const fetchSongs = async () => {
      try {
        ...
        const res = await axios.get(
          ...
          // encodedURIComponent -> converts string into URI acceptable component
        );
    ...
    const debounce = setTimeout(fetchSongs, 1000); // api call occurs once for every 400 milli sec
